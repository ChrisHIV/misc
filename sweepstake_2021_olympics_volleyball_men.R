...
teams <- c("Japan", "Poland", "Italy", "Canada", "Iran", "Venezuela",
           "Brazil", "US", "Russia", "Argentina", "France", "Tunisia")
...
#    Brazil    Canada    Russia      Iran     Japan   Tunisia    France    Poland Venezuela Argentina     Italy        US 
